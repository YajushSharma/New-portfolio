    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center pt-24 pb-12 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 text-center z-10">
        ...
        >
          ...
          <span className="text-sm font-medium text-gray-300">Accepting New Clients</span>
        </motion.div>
        ...
        >
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-accent to-brand-primary inline-block pb-2 md:pb-4">
            {currentText}
        ...
        >
          ...
          <button 
            ...
            className="group relative w-full md:w-auto h-16 md:h-14 px-8 rounded-full font-bold text-lg text-white overflow-hidden transition-all hover:scale-[1.02] active:scale-[0.98] shadow-[0_0_20px_rgba(6,182,212,0.3)] hover:shadow-[0_0_30px_rgba(6,182,212,0.5)]"
          >
            {/* Gradient Background */}
            ...
            <div className="relative z-10 w-full h-full overflow-hidden">
               <div className="flex flex-col h-[200%] transition-transform duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:-translate-y-1/2">
          ...
          <button 
            ...
            className="group w-full md:w-auto h-16 md:h-14 px-8 rounded-full font-bold text-lg text-white border border-white/10 hover:bg-white/5 transition-all relative overflow-hidden active:scale-[0.98]"
          >
