            ...
            <div className="relative rounded-2xl overflow-hidden bg-black border border-white/10 shadow-2xl">
              ...
              <div className="relative z-10 overflow-hidden">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <p className="text-white font-bold text-xl font-display">Yajush Sharma</p>
                  <p className="text-accent-purple font-medium">Video Editor</p>
                </div>
              </div>
            </div>
            
            {/* Decorative Elements */}
            <div className="absolute -top-10 -left-10 w-32 h-32 bg-accent-purple/20 rounded-full blur-3xl opacity-50" />
            <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-accent-pink/20 rounded-full blur-3xl opacity-50" />
          </motion.div>
